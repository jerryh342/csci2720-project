...
>>>>>>> 5bf507114c7791412a24e93e00a0d914ba51b872
...
export const SignUp = () => {
  ...
  const role = JSON.parse(sessionStorage.getItem('role')).value;
  ...
  return (
    <>
      <NavBar component={<UserAddOutlined />} />
      {!formSubmit ? (<div style={{ display: "flex", justifyContent: "center", marginTop: 100 }}>
        <Form
          form={form}
          name="basic"
          labelCol={{
